...
public class TextLineNumber extends JPanel
    ...
    public void setPaintedLines(int... paintedLines) {
        this.paintedLines = paintedLines;
        Arrays.sort(this.paintedLines);
    }

    public void setPaintedLines(String... lines) {
        this.paintedLines = new int[lines.length];
        for (int i = 0; i < paintedLines.length; i++) {
            this.paintedLines[i] = Integer.valueOf(lines[i]);
        }
        Arrays.sort(this.paintedLines);
    }

    public void setPaintedLines(Integer... lines) {
        this.paintedLines = new int[lines.length];
        for (int i = 0; i < paintedLines.length; i++) {
            this.paintedLines[i] = lines[i];
        }
        Arrays.sort(this.paintedLines);
    }
    ...
    public void paintComponent(Graphics g) {
        ...
        while (rowStartOffset <= endOffset) {
            try {
                ...
                if (this.paintedLines != null) {
                    if (Arrays.binarySearch(paintedLines, Integer.parseInt(lineNumber)) >= 0) {
