...
import com.ensamblatore.exceptions.FatalException;
...
public class AssemblerEditor extends javax.swing.JFrame {
    ...
    public AssemblerEditor(EnsamblatoreApplication parent) {
        this.parent = parent;
        initComponents();
        initData();
    }
            ...
            public void actionPerformed(ActionEvent ae) {
                switch(typeId){
                    ...
                    case Line.ID_VARIABLEUSAGE:
                        ...
                        break;
                    default:
                        throw new FatalException("Error in code parsing for popup menu, please contact support");
                }
            }
        });
        jp.add(jm1);
