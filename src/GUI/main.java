...
public class main extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtarProcessorBits = new javax.swing.JLabel();
        ...
        jLabel24.setText("Processor's bits");
        jPanel2.add(jLabel24);

        txtarProcessorBits.setText("vc");
        jPanel2.add(txtarProcessorBits);
    ...
    private javax.swing.JLabel txtarProcessorBits;
    ...
    private void initData() {
        ...
        this.txtarProcessorBits.setText(Integer.toString(ar.getProcesorBits()));
    ...
    public void updateArchitectureData(String big, String data, String little, String program, int wordSize, int processorBits, int PCIncrement, int pIREG, int dIREG, Architecture.Endianess endianess) {
        Architecture arc;
        ...
        arc.setProcesorBits(processorBits);
    ...
    void updateArchitectureData() {
        updateArchitectureDataDraw();
        updateMemories();
    }

    boolean exportMemory(Memory memory) {
        fc.resetChoosableFileFilters();
        fc.addChoosableFileFilter(txt);
        File file = fc.getSelectedFile();
        if (file != null) {
