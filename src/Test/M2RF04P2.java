...
public class M2RF04P2 {
    public static void main(String[] args) {
        ...
        sectors1.add(new InstructionSector(0,5,"f",AddressingMode.INMEDIATO));
        sectors1.add(new InstructionSector(6,9,"sX",AddressingMode.INMEDIATO));
        sectors1.add(new InstructionSector(10,17,"K",AddressingMode.INMEDIATO));
        ...
        sectors2.add(new InstructionSector(0,5,"f",AddressingMode.INMEDIATO));
        sectors2.add(new InstructionSector(6,9,"sX",AddressingMode.INMEDIATO));
        sectors2.add(new InstructionSector(10,13,"sY",AddressingMode.INMEDIATO));
        sectors2.add(new InstructionSector(14,17,"f2",AddressingMode.INMEDIATO));
        ...
        sectors3.add(new InstructionSector(0,5,"f",AddressingMode.INMEDIATO));
        sectors3.add(new InstructionSector(6,9,"sX",AddressingMode.INMEDIATO));
        sectors3.add(new InstructionSector(10,17,"P",AddressingMode.INMEDIATO));
        ...
        sectors4.add(new InstructionSector(0,17,"f",AddressingMode.INMEDIATO));
        ...
        sectors5.add(new InstructionSector(0,5,"f",AddressingMode.INMEDIATO));
        sectors5.add(new InstructionSector(6,9,"sX",AddressingMode.INMEDIATO));
        sectors5.add(new InstructionSector(10,17,"f2",AddressingMode.INMEDIATO));
        ...
        sectors6.add(new InstructionSector(0,5,"f",AddressingMode.INMEDIATO));
        sectors6.add(new InstructionSector(6,9,"sX",AddressingMode.INMEDIATO));
        sectors6.add(new InstructionSector(10,13,"sY",AddressingMode.INMEDIATO));
        sectors6.add(new InstructionSector(14,17,"f2",AddressingMode.INMEDIATO));
